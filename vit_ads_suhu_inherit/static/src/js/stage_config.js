...
export const STAGES = [
    ...
    { id: "vit.image_generator", label: "Image Generator", parent: "vit.ads_copy", hidden: true },
    { id: "vit.video_generator", label: "Video Generator", parent: "vit.ads_copy", hidden: true },
