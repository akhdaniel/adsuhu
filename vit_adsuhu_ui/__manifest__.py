{
    ...
    'assets': {
        'web.assets_frontend': [
            ...
            'vit_adsuhu_ui/static/src/js/stepper.js',
            'vit_adsuhu_ui/static/src/js/stage_view.js',
            'vit_adsuhu_ui/static/src/js/generate_button.js',
            'vit_adsuhu_ui/static/src/js/image_gallery.js',
            'vit_adsuhu_ui/static/src/js/social_poster.js',
            'vit_adsuhu_ui/static/src/js/html_editor.js',
            ...
            'vit_adsuhu_ui/static/src/xml/html_editor.xml',
